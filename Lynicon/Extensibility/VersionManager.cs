...
namespace Lynicon.Extensibility
{
    ...
    public class VersionManager
    {
        ...
        protected Stack<VersioningState> StateStack
        {
            get
            {
                if (!RequestThreadCache.Current.Contains(StateStackKey))
        ...
        public VersioningMode Mode
        {
            get
            {
                if (!RequestThreadCache.Current.Contains(ModeKey))
        ...
        public ItemVersion SpecificVersion
        {
            get
            {
                if (!RequestThreadCache.Current.Contains(SpecificVersionKey))
        ...
        public const string VersionOverrideKey = "VOver";
        /// <summary>
        ...
        public ItemVersion ClientVersionOverride
        {
            get
            {
                var vOver = CookieManager.Instance.LyniconCookie[VersionOverrideKey];
                if (vOver == null)
                    return new ItemVersion();
                else
            ...
            set
            {
                CookieManager.Instance.LyniconCookie[VersionOverrideKey] = value.ToString();
        ...
        public ItemVersion CurrentVersion
        {
            get
            {
                if (Mode != VersioningMode.Current
                    ...
                    || !RequestThreadCache.Current.Contains(CurrentVersionKey))
                {
                    ItemVersion iv = null;
