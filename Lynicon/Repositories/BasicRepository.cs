...
namespace Lynicon.Repositories
{
    ...
    public class BasicRepository : IRepository
    {
        ...
        public IEnumerable<T> BasicGet<T, TQuery>(Type targetType, Func<IQueryable<TQuery>, IQueryable<TQuery>> queryBody)
            where T : class
            where TQuery : class
        {
            bool isSummary = typeof(Summary).IsAssignableFrom(targetType);
        ...
        public List<string> GetFieldsForSummary(Type contentType, Type summaryType)
        {
