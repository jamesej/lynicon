...
namespace Lynicon.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult Rename(string dataType, string path, bool pathInSummary, string newPath, bool newPathInSummary, bool? isDelete)
        {
        ...
        [HttpPost, Authorize(Roles = Membership.User.AdminRole)]
        public ActionResult ResolveProblem(Guid Id)
        {
        ...
        [Authorize(Roles = Membership.User.AdminRole)]
        public ActionResult ScanReferences()
        {
