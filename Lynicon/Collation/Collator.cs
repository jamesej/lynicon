...
namespace Lynicon.Collation
{
    ...
    /// </summary>
    public class Collator : TypeRegistry<ICollator>, ICollator
    {
        static readonly Collator instance = new Collator(Lynicon.Repositories.Repository.Instance);
        /// <summary>
        /// The global collator
        /// </summary>
        ...
        /// <summary>
        /// Initialise the core dbcontext, the collator and the repository for a content type
        /// </summary>
        /// <param name="t">content type</param>
        /// <param name="coll">the collator</param>
        /// <param name="repo">the repository</param>
        public void SetupType(Type t, ICollator coll, IRepository repo)
        {
            SetupType(t, coll, repo, null);
        }
        /// <summary>
        /// Initialise the core dbcontext, the collator, the repository and the editor redirect for a content type
        /// </summary>
        ...
        /// <param name="coll">the collator</param>
        /// <param name="repo">the repository</param>
        public void SetupType<T>(ICollator coll, IRepository repo)
        {
            SetupType(typeof(T), coll, repo);
        }
        ...
        /// </summary>
        /// <typeparam name="T">content type</typeparam>
        public void SetupTypeForBasic<T>()
        {
            SetupType(typeof(T), new BasicCollator(Repository), new BasicRepository(new CoreDataSourceFactory()));
        }
        ...
        public PropertyInfo GetIdProperty(Type containerType)
        {
            return Registered(containerType).GetIdProperty(containerType);
        }
    }
}
