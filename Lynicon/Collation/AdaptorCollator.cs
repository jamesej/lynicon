...
namespace Lynicon.Collation
{
        ...
        where TTo : class, new()
    {
        ...
        {
            get { return baseCollator.Repository; }
            set { baseCollator.Repository = value; }
        }

        /// <inheritdoc/>
        public override Type AssociatedContainerType
        {
            get { return baseCollator.AssociatedContainerType; }
        }
        ...
        {
            if (data is TTo)
                baseCollator.Delete(a, writeConvert(data as TTo, new TFrom()), bypassChecks);
            else
