...
{
    /// <summary>
    /// Collator where the container is identical to what it contains
    /// </summary>
    public class BasicCollator : BaseCollator, ICollator
    {
        ...
        {
            return ((BasicRepository)Lynicon.Repositories.Repository.Instance.Registered(t)).GetIdProperty(t).Name;
        }
