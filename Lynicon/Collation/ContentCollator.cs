...
{
    /// <summary>
    /// Collator for the Content persistence model (which JSON encodes content data into summary and content fields,
    /// storing metadata in the other fields)
    /// </summary>
    public class ContentCollator : BaseCollator, ICollator
    {
        ...
        /// <summary>
        /// Create a new content collator, using the supplied repository registry
        /// </summary>
        ...
        /// <inheritdoc/>
        public override Type AssociatedContainerType
        {
        ...
        {
            // Attempt to choose the most efficient way of running the query
